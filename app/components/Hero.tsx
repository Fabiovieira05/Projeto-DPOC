...
export default function Hero() {
  return (
    <main className="mx-auto w-full max-w-7xl px-4 py-8 md:px-6 md:py-12">
      <section className="flex flex-col-reverse items-center gap-6 md:flex-row md:items-center">
        <div className="md:flex-1">
          <h1 className="hero-title text-[#0f1720] leading-tight">
            Respirar bem é
            <span className="ml-2 italic text-dpoc-green">viver melhor!</span>
          </h1>
          <p className="mt-6 max-w-xl text-sm md:text-lg text-zinc-700">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            ...
            <a href="#" className="btn-dpoc-outline inline-flex items-center justify-center rounded-md px-5 py-2 sm:px-6 sm:py-3 font-medium">
              Prevenção
            </a>
          </div>
        </div>
